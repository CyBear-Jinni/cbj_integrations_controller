...
class _$RoomsActionDoesNotExistImpl<T> implements _RoomsActionDoesNotExist<T> {
  ...
  @override
  String toString() {
    return 'SceneCbjFailure<$T>.roomsActionDoesNotExist()';
  }
...
abstract class _RoomsActionDoesNotExist<T> implements SceneCbjFailure<T> {
...
class _$RoomsTypeDoesNotExistImpl<T> implements _RoomsTypeDoesNotExist<T> {
  ...
  @override
  String toString() {
    return 'SceneCbjFailure<$T>.roomsTypeDoesNotExist()';
  }
...
abstract class _RoomsTypeDoesNotExist<T> implements SceneCbjFailure<T> {
