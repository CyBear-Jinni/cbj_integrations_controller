...
part of 'local_db_failures.dart';
...
/// @nodoc
abstract class $LocalDbFailuresCopyWith<T, $Res> {
  factory $LocalDbFailuresCopyWith(
          LocalDbFailures<T> value, $Res Function(LocalDbFailures<T>) then) =
      _$LocalDbFailuresCopyWithImpl<T, $Res, LocalDbFailures<T>>;
}

/// @nodoc
class _$LocalDbFailuresCopyWithImpl<T, $Res, $Val extends LocalDbFailures<T>>
    implements $LocalDbFailuresCopyWith<T, $Res> {
  _$LocalDbFailuresCopyWithImpl(this._value, this._then);
...
class __$$EmptyImplCopyWithImpl<T, $Res>
    extends _$LocalDbFailuresCopyWithImpl<T, $Res, _$EmptyImpl<T>>
...
class _$EmptyImpl<T> implements _Empty<T> {
  ...
  @override
  String toString() {
    return 'LocalDbFailures<$T>.empty(failedValue: $failedValue)';
  }
...
abstract class _Empty<T> implements LocalDbFailures<T> {
...
class __$$UnexpectedImplCopyWithImpl<T, $Res>
    extends _$LocalDbFailuresCopyWithImpl<T, $Res, _$UnexpectedImpl<T>>
...
class _$UnexpectedImpl<T> implements _Unexpected<T> {
  ...
  @override
  String toString() {
    return 'LocalDbFailures<$T>.unexpected()';
  }
...
abstract class _Unexpected<T> implements LocalDbFailures<T> {
...
class __$$ValidateEmailNotEmptyImplCopyWithImpl<T, $Res>
    extends _$LocalDbFailuresCopyWithImpl<T, $Res,
        _$ValidateEmailNotEmptyImpl<T>>
...
class _$ValidateEmailNotEmptyImpl<T> implements _ValidateEmailNotEmpty<T> {
  ...
  @override
  String toString() {
    return 'LocalDbFailures<$T>.validateEmailNotEmpty()';
  }
...
abstract class _ValidateEmailNotEmpty<T> implements LocalDbFailures<T> {
...
class _$InsufficientPermissionImpl<T> implements _InsufficientPermission<T> {
  ...
  @override
  String toString() {
    return 'LocalDbFailures<$T>.insufficientPermission()';
  }
...
abstract class _InsufficientPermission<T> implements LocalDbFailures<T> {
...
class __$$UnableToUpdateImplCopyWithImpl<T, $Res>
    extends _$LocalDbFailuresCopyWithImpl<T, $Res, _$UnableToUpdateImpl<T>>
...
class _$UnableToUpdateImpl<T> implements _UnableToUpdate<T> {
  ...
  @override
  String toString() {
    return 'LocalDbFailures<$T>.unableToUpdate()';
  }
...
abstract class _UnableToUpdate<T> implements LocalDbFailures<T> {
