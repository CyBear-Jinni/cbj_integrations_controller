...
GenericSmartPlugDeviceDtos _$GenericSmartPlugDeviceDtosFromJson(
    Map<String, dynamic> json) {
  return _GenericSmartPlugDeviceDtos.fromJson(json);
}

/// @nodoc
mixin _$GenericSmartPlugDeviceDtos {
// @JsonKey(ignore: true)
  ...
  String? get smartPlugState => throw _privateConstructorUsedError;
  ...
  /// Serializes this GenericSmartPlugDeviceDtos to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of GenericSmartPlugDeviceDtos
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $GenericSmartPlugDeviceDtosCopyWith<GenericSmartPlugDeviceDtos>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $GenericSmartPlugDeviceDtosCopyWith<$Res> {
  factory $GenericSmartPlugDeviceDtosCopyWith(GenericSmartPlugDeviceDtos value,
          $Res Function(GenericSmartPlugDeviceDtos) then) =
      _$GenericSmartPlugDeviceDtosCopyWithImpl<$Res,
          GenericSmartPlugDeviceDtos>;
  @useResult
  $Res call(
      {String id,
...
/// @nodoc
class _$GenericSmartPlugDeviceDtosCopyWithImpl<$Res,
        $Val extends GenericSmartPlugDeviceDtos>
    implements $GenericSmartPlugDeviceDtosCopyWith<$Res> {
  _$GenericSmartPlugDeviceDtosCopyWithImpl(this._value, this._then);
    ...
    return _then(_value.copyWith(
      ...
      senderId: freezed == senderId
          ...
          : senderId // ignore: cast_nullable_to_non_nullable
              as String?,
      smartPlugState: freezed == smartPlugState
          ? _value.smartPlugState
          : smartPlugState // ignore: cast_nullable_to_non_nullable
              as String?,
...
/// @nodoc
abstract class _$$GenericSmartPlugDeviceDtosImplCopyWith<$Res>
    implements $GenericSmartPlugDeviceDtosCopyWith<$Res> {
  factory _$$GenericSmartPlugDeviceDtosImplCopyWith(
          _$GenericSmartPlugDeviceDtosImpl value,
          $Res Function(_$GenericSmartPlugDeviceDtosImpl) then) =
      __$$GenericSmartPlugDeviceDtosImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String id,
...
/// @nodoc
class __$$GenericSmartPlugDeviceDtosImplCopyWithImpl<$Res>
    extends _$GenericSmartPlugDeviceDtosCopyWithImpl<$Res,
        _$GenericSmartPlugDeviceDtosImpl>
    implements _$$GenericSmartPlugDeviceDtosImplCopyWith<$Res> {
  __$$GenericSmartPlugDeviceDtosImplCopyWithImpl(
      _$GenericSmartPlugDeviceDtosImpl _value,
      $Res Function(_$GenericSmartPlugDeviceDtosImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$GenericSmartPlugDeviceDtosImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$GenericSmartPlugDeviceDtosImpl extends _GenericSmartPlugDeviceDtos {
  _$GenericSmartPlugDeviceDtosImpl(
      {required this.id,
  ...
  factory _$GenericSmartPlugDeviceDtosImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$GenericSmartPlugDeviceDtosImplFromJson(json);
...
// @JsonKey(ignore: true)
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.smartPlugState, smartPlugState) ||
                other.smartPlugState == smartPlugState) &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$GenericSmartPlugDeviceDtosImplCopyWith<_$GenericSmartPlugDeviceDtosImpl>
      get copyWith => __$$GenericSmartPlugDeviceDtosImplCopyWithImpl<
          _$GenericSmartPlugDeviceDtosImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$GenericSmartPlugDeviceDtosImplToJson(
      this,
    );
  }
}

abstract class _GenericSmartPlugDeviceDtos extends GenericSmartPlugDeviceDtos {
  factory _GenericSmartPlugDeviceDtos(
      ...
      required final String? smartPlugState,
  ...
  factory _GenericSmartPlugDeviceDtos.fromJson(Map<String, dynamic> json) =
      _$GenericSmartPlugDeviceDtosImpl.fromJson;
