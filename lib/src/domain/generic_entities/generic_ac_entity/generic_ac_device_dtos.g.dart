...
_$GenericAcDeviceDtosImpl _$$GenericAcDeviceDtosImplFromJson(
    ...
    _$GenericAcDeviceDtosImpl(
      ...
      acSwitchState: json['acSwitchState'] as String?,
...
Map<String, dynamic> _$$GenericAcDeviceDtosImplToJson(
        _$GenericAcDeviceDtosImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
      ...
      'acSwitchState': instance.acSwitchState,
