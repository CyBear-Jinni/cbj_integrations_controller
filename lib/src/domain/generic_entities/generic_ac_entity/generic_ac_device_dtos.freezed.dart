...
part of 'generic_ac_device_dtos.dart';
...
GenericAcDeviceDtos _$GenericAcDeviceDtosFromJson(Map<String, dynamic> json) {
  return _GenericAcDeviceDtos.fromJson(json);
}

/// @nodoc
mixin _$GenericAcDeviceDtos {
// @JsonKey(ignore: true)
  ...
  String? get acSwitchState => throw _privateConstructorUsedError;
  ...
  String? get fanLevel => throw _privateConstructorUsedError;
  String? get light => throw _privateConstructorUsedError;

  /// Serializes this GenericAcDeviceDtos to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of GenericAcDeviceDtos
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $GenericAcDeviceDtosCopyWith<GenericAcDeviceDtos> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $GenericAcDeviceDtosCopyWith<$Res> {
  factory $GenericAcDeviceDtosCopyWith(
          GenericAcDeviceDtos value, $Res Function(GenericAcDeviceDtos) then) =
      _$GenericAcDeviceDtosCopyWithImpl<$Res, GenericAcDeviceDtos>;
  @useResult
  $Res call(
      {String id,
...
/// @nodoc
class _$GenericAcDeviceDtosCopyWithImpl<$Res, $Val extends GenericAcDeviceDtos>
    implements $GenericAcDeviceDtosCopyWith<$Res> {
  _$GenericAcDeviceDtosCopyWithImpl(this._value, this._then);
    ...
    return _then(_value.copyWith(
      ...
      senderId: freezed == senderId
          ...
          : senderId // ignore: cast_nullable_to_non_nullable
              as String?,
      acSwitchState: freezed == acSwitchState
          ? _value.acSwitchState
          : acSwitchState // ignore: cast_nullable_to_non_nullable
              as String?,
...
/// @nodoc
abstract class _$$GenericAcDeviceDtosImplCopyWith<$Res>
    implements $GenericAcDeviceDtosCopyWith<$Res> {
  factory _$$GenericAcDeviceDtosImplCopyWith(_$GenericAcDeviceDtosImpl value,
          $Res Function(_$GenericAcDeviceDtosImpl) then) =
      __$$GenericAcDeviceDtosImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String id,
...
/// @nodoc
class __$$GenericAcDeviceDtosImplCopyWithImpl<$Res>
    extends _$GenericAcDeviceDtosCopyWithImpl<$Res, _$GenericAcDeviceDtosImpl>
    implements _$$GenericAcDeviceDtosImplCopyWith<$Res> {
  __$$GenericAcDeviceDtosImplCopyWithImpl(_$GenericAcDeviceDtosImpl _value,
      $Res Function(_$GenericAcDeviceDtosImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$GenericAcDeviceDtosImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$GenericAcDeviceDtosImpl extends _GenericAcDeviceDtos {
  _$GenericAcDeviceDtosImpl(
      {required this.id,
  ...
  factory _$GenericAcDeviceDtosImpl.fromJson(Map<String, dynamic> json) =>
      _$$GenericAcDeviceDtosImplFromJson(json);
...
// @JsonKey(ignore: true)
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$GenericAcDeviceDtosImpl &&
            ...
            (identical(other.acSwitchState, acSwitchState) ||
                other.acSwitchState == acSwitchState) &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$GenericAcDeviceDtosImplCopyWith<_$GenericAcDeviceDtosImpl> get copyWith =>
      __$$GenericAcDeviceDtosImplCopyWithImpl<_$GenericAcDeviceDtosImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$GenericAcDeviceDtosImplToJson(
      this,
    );
  }
}

abstract class _GenericAcDeviceDtos extends GenericAcDeviceDtos {
  factory _GenericAcDeviceDtos(
      ...
      required final String? acSwitchState,
      ...
      required final String? deviceDtoClass,
      required final String? stateMassage,
      required final String? mode,
      required final String? fanLevel,
      required final String? light}) = _$GenericAcDeviceDtosImpl;
  _GenericAcDeviceDtos._() : super._();

  factory _GenericAcDeviceDtos.fromJson(Map<String, dynamic> json) =
      _$GenericAcDeviceDtosImpl.fromJson;
