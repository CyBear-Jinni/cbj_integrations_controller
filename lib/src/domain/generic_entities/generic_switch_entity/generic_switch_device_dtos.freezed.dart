...
GenericSwitchDeviceDtos _$GenericSwitchDeviceDtosFromJson(
    Map<String, dynamic> json) {
  return _GenericSwitchDeviceDtos.fromJson(json);
}

/// @nodoc
mixin _$GenericSwitchDeviceDtos {
// @JsonKey(ignore: true)
  ...
  String? get switchState => throw _privateConstructorUsedError;
  ...
  /// Serializes this GenericSwitchDeviceDtos to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of GenericSwitchDeviceDtos
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $GenericSwitchDeviceDtosCopyWith<GenericSwitchDeviceDtos> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $GenericSwitchDeviceDtosCopyWith<$Res> {
  factory $GenericSwitchDeviceDtosCopyWith(GenericSwitchDeviceDtos value,
          $Res Function(GenericSwitchDeviceDtos) then) =
      _$GenericSwitchDeviceDtosCopyWithImpl<$Res, GenericSwitchDeviceDtos>;
  @useResult
  $Res call(
      {String id,
...
/// @nodoc
class _$GenericSwitchDeviceDtosCopyWithImpl<$Res,
        $Val extends GenericSwitchDeviceDtos>
    implements $GenericSwitchDeviceDtosCopyWith<$Res> {
  _$GenericSwitchDeviceDtosCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$GenericSwitchDeviceDtosImplCopyWith<$Res>
    implements $GenericSwitchDeviceDtosCopyWith<$Res> {
  factory _$$GenericSwitchDeviceDtosImplCopyWith(
          _$GenericSwitchDeviceDtosImpl value,
          $Res Function(_$GenericSwitchDeviceDtosImpl) then) =
      __$$GenericSwitchDeviceDtosImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String id,
...
/// @nodoc
class __$$GenericSwitchDeviceDtosImplCopyWithImpl<$Res>
    extends _$GenericSwitchDeviceDtosCopyWithImpl<$Res,
        _$GenericSwitchDeviceDtosImpl>
    implements _$$GenericSwitchDeviceDtosImplCopyWith<$Res> {
  __$$GenericSwitchDeviceDtosImplCopyWithImpl(
      _$GenericSwitchDeviceDtosImpl _value,
      $Res Function(_$GenericSwitchDeviceDtosImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$GenericSwitchDeviceDtosImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$GenericSwitchDeviceDtosImpl extends _GenericSwitchDeviceDtos {
  _$GenericSwitchDeviceDtosImpl(
      {required this.id,
  ...
  factory _$GenericSwitchDeviceDtosImpl.fromJson(Map<String, dynamic> json) =>
      _$$GenericSwitchDeviceDtosImplFromJson(json);
...
// @JsonKey(ignore: true)
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$GenericSwitchDeviceDtosImplCopyWith<_$GenericSwitchDeviceDtosImpl>
      get copyWith => __$$GenericSwitchDeviceDtosImplCopyWithImpl<
          _$GenericSwitchDeviceDtosImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$GenericSwitchDeviceDtosImplToJson(
      this,
    );
  }
}

abstract class _GenericSwitchDeviceDtos extends GenericSwitchDeviceDtos {
  factory _GenericSwitchDeviceDtos(
      ...
      required final String? switchState,
      ...
      final String? deviceDtoClass,
      final String? stateMassage}) = _$GenericSwitchDeviceDtosImpl;
  _GenericSwitchDeviceDtos._() : super._();

  factory _GenericSwitchDeviceDtos.fromJson(Map<String, dynamic> json) =
      _$GenericSwitchDeviceDtosImpl.fromJson;
