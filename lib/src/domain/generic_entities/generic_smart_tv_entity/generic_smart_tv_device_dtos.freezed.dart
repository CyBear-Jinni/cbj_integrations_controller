...
GenericSmartTvDeviceDtos _$GenericSmartTvDeviceDtosFromJson(
    Map<String, dynamic> json) {
  return _GenericSmartTvDeviceDtos.fromJson(json);
}

/// @nodoc
mixin _$GenericSmartTvDeviceDtos {
// @JsonKey(ignore: true)
  ...
  /// Serializes this GenericSmartTvDeviceDtos to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of GenericSmartTvDeviceDtos
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $GenericSmartTvDeviceDtosCopyWith<GenericSmartTvDeviceDtos> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $GenericSmartTvDeviceDtosCopyWith<$Res> {
  factory $GenericSmartTvDeviceDtosCopyWith(GenericSmartTvDeviceDtos value,
          $Res Function(GenericSmartTvDeviceDtos) then) =
      _$GenericSmartTvDeviceDtosCopyWithImpl<$Res, GenericSmartTvDeviceDtos>;
  @useResult
  $Res call(
      {String id,
...
/// @nodoc
class _$GenericSmartTvDeviceDtosCopyWithImpl<$Res,
        $Val extends GenericSmartTvDeviceDtos>
    implements $GenericSmartTvDeviceDtosCopyWith<$Res> {
  _$GenericSmartTvDeviceDtosCopyWithImpl(this._value, this._then);
    ...
    return _then(_value.copyWith(
      ...
      senderId: freezed == senderId
          ...
          : senderId // ignore: cast_nullable_to_non_nullable
              as String?,
      smartTvSwitchState: freezed == smartTvSwitchState
          ? _value.smartTvSwitchState
          : smartTvSwitchState // ignore: cast_nullable_to_non_nullable
              as String?,
...
/// @nodoc
abstract class _$$GenericSmartTvDeviceDtosImplCopyWith<$Res>
    implements $GenericSmartTvDeviceDtosCopyWith<$Res> {
  factory _$$GenericSmartTvDeviceDtosImplCopyWith(
          _$GenericSmartTvDeviceDtosImpl value,
          $Res Function(_$GenericSmartTvDeviceDtosImpl) then) =
      __$$GenericSmartTvDeviceDtosImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String id,
...
/// @nodoc
class __$$GenericSmartTvDeviceDtosImplCopyWithImpl<$Res>
    extends _$GenericSmartTvDeviceDtosCopyWithImpl<$Res,
        _$GenericSmartTvDeviceDtosImpl>
    implements _$$GenericSmartTvDeviceDtosImplCopyWith<$Res> {
  __$$GenericSmartTvDeviceDtosImplCopyWithImpl(
      _$GenericSmartTvDeviceDtosImpl _value,
      $Res Function(_$GenericSmartTvDeviceDtosImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$GenericSmartTvDeviceDtosImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$GenericSmartTvDeviceDtosImpl extends _GenericSmartTvDeviceDtos {
  _$GenericSmartTvDeviceDtosImpl(
      {required this.id,
  ...
  factory _$GenericSmartTvDeviceDtosImpl.fromJson(Map<String, dynamic> json) =>
      _$$GenericSmartTvDeviceDtosImplFromJson(json);
...
// @JsonKey(ignore: true)
  ...
  @override
  final String? smartTvSwitchState;
  @override
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.smartTvSwitchState, smartTvSwitchState) ||
                other.smartTvSwitchState == smartTvSwitchState) &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$GenericSmartTvDeviceDtosImplCopyWith<_$GenericSmartTvDeviceDtosImpl>
      get copyWith => __$$GenericSmartTvDeviceDtosImplCopyWithImpl<
          _$GenericSmartTvDeviceDtosImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$GenericSmartTvDeviceDtosImplToJson(
      this,
    );
  }
}

abstract class _GenericSmartTvDeviceDtos extends GenericSmartTvDeviceDtos {
  factory _GenericSmartTvDeviceDtos(
  ...
  _GenericSmartTvDeviceDtos._() : super._();

  factory _GenericSmartTvDeviceDtos.fromJson(Map<String, dynamic> json) =
      _$GenericSmartTvDeviceDtosImpl.fromJson;
