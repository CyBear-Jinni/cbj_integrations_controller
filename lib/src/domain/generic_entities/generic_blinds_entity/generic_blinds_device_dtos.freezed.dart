...
GenericBlindsDeviceDtos _$GenericBlindsDeviceDtosFromJson(
    Map<String, dynamic> json) {
  return _GenericBlindsDeviceDtos.fromJson(json);
}

/// @nodoc
mixin _$GenericBlindsDeviceDtos {
// @JsonKey(ignore: true)
  ...
  String? get blindsSwitchState => throw _privateConstructorUsedError;
  ...
  /// Serializes this GenericBlindsDeviceDtos to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of GenericBlindsDeviceDtos
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $GenericBlindsDeviceDtosCopyWith<GenericBlindsDeviceDtos> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $GenericBlindsDeviceDtosCopyWith<$Res> {
  factory $GenericBlindsDeviceDtosCopyWith(GenericBlindsDeviceDtos value,
          $Res Function(GenericBlindsDeviceDtos) then) =
      _$GenericBlindsDeviceDtosCopyWithImpl<$Res, GenericBlindsDeviceDtos>;
  @useResult
  $Res call(
      {String id,
...
/// @nodoc
class _$GenericBlindsDeviceDtosCopyWithImpl<$Res,
        $Val extends GenericBlindsDeviceDtos>
    implements $GenericBlindsDeviceDtosCopyWith<$Res> {
  _$GenericBlindsDeviceDtosCopyWithImpl(this._value, this._then);
  ...
  $Res call({
    ...
    Object? blindsSwitchState = freezed,
    ...
    return _then(_value.copyWith(
      ...
      senderId: freezed == senderId
          ...
          : senderId // ignore: cast_nullable_to_non_nullable
              as String?,
      blindsSwitchState: freezed == blindsSwitchState
          ? _value.blindsSwitchState
          : blindsSwitchState // ignore: cast_nullable_to_non_nullable
              as String?,
...
/// @nodoc
abstract class _$$GenericBlindsDeviceDtosImplCopyWith<$Res>
    implements $GenericBlindsDeviceDtosCopyWith<$Res> {
  factory _$$GenericBlindsDeviceDtosImplCopyWith(
          _$GenericBlindsDeviceDtosImpl value,
          $Res Function(_$GenericBlindsDeviceDtosImpl) then) =
      __$$GenericBlindsDeviceDtosImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String id,
...
/// @nodoc
class __$$GenericBlindsDeviceDtosImplCopyWithImpl<$Res>
    extends _$GenericBlindsDeviceDtosCopyWithImpl<$Res,
        _$GenericBlindsDeviceDtosImpl>
    implements _$$GenericBlindsDeviceDtosImplCopyWith<$Res> {
  __$$GenericBlindsDeviceDtosImplCopyWithImpl(
      _$GenericBlindsDeviceDtosImpl _value,
      $Res Function(_$GenericBlindsDeviceDtosImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$GenericBlindsDeviceDtosImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$GenericBlindsDeviceDtosImpl extends _GenericBlindsDeviceDtos {
  _$GenericBlindsDeviceDtosImpl(
      {required this.id,
  ...
  factory _$GenericBlindsDeviceDtosImpl.fromJson(Map<String, dynamic> json) =>
      _$$GenericBlindsDeviceDtosImplFromJson(json);
...
// @JsonKey(ignore: true)
  ...
  @override
  final String? blindsSwitchState;
  @override
  ...
  @override
  String toString() {
    return 'GenericBlindsDeviceDtos(id: $id, entityUniqueId: $entityUniqueId, cbjEntityName: $cbjEntityName, entityOriginalName: $entityOriginalName, deviceOriginalName: $deviceOriginalName, entityStateGRPC: $entityStateGRPC, senderDeviceOs: $senderDeviceOs, senderDeviceModel: $senderDeviceModel, senderId: $senderId, blindsSwitchState: $blindsSwitchState, entityTypes: $entityTypes, compUuid: $compUuid, cbjDeviceVendor: $cbjDeviceVendor, deviceVendor: $deviceVendor, deviceNetworkLastUpdate: $deviceNetworkLastUpdate, powerConsumption: $powerConsumption, deviceUniqueId: $deviceUniqueId, devicePort: $devicePort, deviceLastKnownIp: $deviceLastKnownIp, deviceHostName: $deviceHostName, deviceMdns: $deviceMdns, srvResourceRecord: $srvResourceRecord, srvTarget: $srvTarget, ptrResourceRecord: $ptrResourceRecord, mdnsServiceType: $mdnsServiceType, devicesMacAddress: $devicesMacAddress, entityKey: $entityKey, requestTimeStamp: $requestTimeStamp, lastResponseFromDeviceTimeStamp: $lastResponseFromDeviceTimeStamp, entityCbjUniqueId: $entityCbjUniqueId, deviceDtoClass: $deviceDtoClass, stateMassage: $stateMassage)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$GenericBlindsDeviceDtosImpl &&
            ...
            (identical(other.blindsSwitchState, blindsSwitchState) ||
                other.blindsSwitchState == blindsSwitchState) &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$GenericBlindsDeviceDtosImplCopyWith<_$GenericBlindsDeviceDtosImpl>
      get copyWith => __$$GenericBlindsDeviceDtosImplCopyWithImpl<
          _$GenericBlindsDeviceDtosImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$GenericBlindsDeviceDtosImplToJson(
      this,
    );
  }
}

abstract class _GenericBlindsDeviceDtos extends GenericBlindsDeviceDtos {
  factory _GenericBlindsDeviceDtos(
      ...
      required final String? blindsSwitchState,
      ...
      final String? deviceDtoClass,
      final String? stateMassage}) = _$GenericBlindsDeviceDtosImpl;
  _GenericBlindsDeviceDtos._() : super._();

  factory _GenericBlindsDeviceDtos.fromJson(Map<String, dynamic> json) =
      _$GenericBlindsDeviceDtosImpl.fromJson;
