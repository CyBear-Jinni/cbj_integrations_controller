...
_$GenericSecurityCameraDeviceDtosImpl
    _$$GenericSecurityCameraDeviceDtosImplFromJson(Map<String, dynamic> json) =>
        _$GenericSecurityCameraDeviceDtosImpl(
...
Map<String, dynamic> _$$GenericSecurityCameraDeviceDtosImplToJson(
        _$GenericSecurityCameraDeviceDtosImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
