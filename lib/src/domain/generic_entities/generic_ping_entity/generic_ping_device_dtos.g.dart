...
_$GenericPingDeviceDtosImpl _$$GenericPingDeviceDtosImplFromJson(
    ...
    _$GenericPingDeviceDtosImpl(
      ...
      pingSwitchState: json['pingSwitchState'] as String?,
...
Map<String, dynamic> _$$GenericPingDeviceDtosImplToJson(
        _$GenericPingDeviceDtosImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
      ...
      'pingSwitchState': instance.pingSwitchState,
