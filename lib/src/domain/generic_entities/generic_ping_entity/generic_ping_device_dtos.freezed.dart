...
part of 'generic_ping_device_dtos.dart';
...
GenericPingDeviceDtos _$GenericPingDeviceDtosFromJson(
    Map<String, dynamic> json) {
  return _GenericPingDeviceDtos.fromJson(json);
}

/// @nodoc
mixin _$GenericPingDeviceDtos {
// @JsonKey(ignore: true)
  ...
  String? get pingSwitchState => throw _privateConstructorUsedError;
  ...
  /// Serializes this GenericPingDeviceDtos to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of GenericPingDeviceDtos
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $GenericPingDeviceDtosCopyWith<GenericPingDeviceDtos> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $GenericPingDeviceDtosCopyWith<$Res> {
  factory $GenericPingDeviceDtosCopyWith(GenericPingDeviceDtos value,
          $Res Function(GenericPingDeviceDtos) then) =
      _$GenericPingDeviceDtosCopyWithImpl<$Res, GenericPingDeviceDtos>;
  @useResult
  $Res call(
      {String id,
...
/// @nodoc
class _$GenericPingDeviceDtosCopyWithImpl<$Res,
        $Val extends GenericPingDeviceDtos>
    implements $GenericPingDeviceDtosCopyWith<$Res> {
  _$GenericPingDeviceDtosCopyWithImpl(this._value, this._then);
  ...
  $Res call({
    ...
    Object? pingSwitchState = freezed,
    ...
    return _then(_value.copyWith(
      ...
      senderId: freezed == senderId
          ...
          : senderId // ignore: cast_nullable_to_non_nullable
              as String?,
      pingSwitchState: freezed == pingSwitchState
          ? _value.pingSwitchState
          : pingSwitchState // ignore: cast_nullable_to_non_nullable
              as String?,
...
/// @nodoc
abstract class _$$GenericPingDeviceDtosImplCopyWith<$Res>
    implements $GenericPingDeviceDtosCopyWith<$Res> {
  factory _$$GenericPingDeviceDtosImplCopyWith(
          _$GenericPingDeviceDtosImpl value,
          $Res Function(_$GenericPingDeviceDtosImpl) then) =
      __$$GenericPingDeviceDtosImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String id,
...
/// @nodoc
class __$$GenericPingDeviceDtosImplCopyWithImpl<$Res>
    extends _$GenericPingDeviceDtosCopyWithImpl<$Res,
        _$GenericPingDeviceDtosImpl>
    implements _$$GenericPingDeviceDtosImplCopyWith<$Res> {
  __$$GenericPingDeviceDtosImplCopyWithImpl(_$GenericPingDeviceDtosImpl _value,
      $Res Function(_$GenericPingDeviceDtosImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$GenericPingDeviceDtosImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$GenericPingDeviceDtosImpl extends _GenericPingDeviceDtos {
  _$GenericPingDeviceDtosImpl(
      {required this.id,
  ...
  factory _$GenericPingDeviceDtosImpl.fromJson(Map<String, dynamic> json) =>
      _$$GenericPingDeviceDtosImplFromJson(json);
...
// @JsonKey(ignore: true)
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$GenericPingDeviceDtosImpl &&
            ...
            (identical(other.pingSwitchState, pingSwitchState) ||
                other.pingSwitchState == pingSwitchState) &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$GenericPingDeviceDtosImplCopyWith<_$GenericPingDeviceDtosImpl>
      get copyWith => __$$GenericPingDeviceDtosImplCopyWithImpl<
          _$GenericPingDeviceDtosImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$GenericPingDeviceDtosImplToJson(
      this,
    );
  }
}

abstract class _GenericPingDeviceDtos extends GenericPingDeviceDtos {
  factory _GenericPingDeviceDtos(
      ...
      required final String? pingSwitchState,
      ...
      final String? deviceDtoClass,
      final String? stateMassage}) = _$GenericPingDeviceDtosImpl;
  _GenericPingDeviceDtos._() : super._();

  factory _GenericPingDeviceDtos.fromJson(Map<String, dynamic> json) =
      _$GenericPingDeviceDtosImpl.fromJson;
