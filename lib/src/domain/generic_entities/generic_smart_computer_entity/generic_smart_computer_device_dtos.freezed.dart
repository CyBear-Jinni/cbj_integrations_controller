...
GenericSmartComputerDeviceDtos _$GenericSmartComputerDeviceDtosFromJson(
    Map<String, dynamic> json) {
  return _GenericSmartComputerDeviceDtos.fromJson(json);
}

/// @nodoc
mixin _$GenericSmartComputerDeviceDtos {
// @JsonKey(ignore: true)
  ...
  /// Serializes this GenericSmartComputerDeviceDtos to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of GenericSmartComputerDeviceDtos
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $GenericSmartComputerDeviceDtosCopyWith<GenericSmartComputerDeviceDtos>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $GenericSmartComputerDeviceDtosCopyWith<$Res> {
  factory $GenericSmartComputerDeviceDtosCopyWith(
          GenericSmartComputerDeviceDtos value,
          $Res Function(GenericSmartComputerDeviceDtos) then) =
      _$GenericSmartComputerDeviceDtosCopyWithImpl<$Res,
...
/// @nodoc
class _$GenericSmartComputerDeviceDtosCopyWithImpl<$Res,
        $Val extends GenericSmartComputerDeviceDtos>
    implements $GenericSmartComputerDeviceDtosCopyWith<$Res> {
  _$GenericSmartComputerDeviceDtosCopyWithImpl(this._value, this._then);
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      smartComputerSuspendState: freezed == smartComputerSuspendState
          ...
          : smartComputerSuspendState // ignore: cast_nullable_to_non_nullable
              as String?,
      smartComputerShutDownState: freezed == smartComputerShutDownState
          ? _value.smartComputerShutDownState
          : smartComputerShutDownState // ignore: cast_nullable_to_non_nullable
              as String?,
...
/// @nodoc
abstract class _$$GenericSmartComputerDeviceDtosImplCopyWith<$Res>
    implements $GenericSmartComputerDeviceDtosCopyWith<$Res> {
  factory _$$GenericSmartComputerDeviceDtosImplCopyWith(
          _$GenericSmartComputerDeviceDtosImpl value,
          $Res Function(_$GenericSmartComputerDeviceDtosImpl) then) =
      __$$GenericSmartComputerDeviceDtosImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String id,
...
/// @nodoc
class __$$GenericSmartComputerDeviceDtosImplCopyWithImpl<$Res>
    extends _$GenericSmartComputerDeviceDtosCopyWithImpl<$Res,
        _$GenericSmartComputerDeviceDtosImpl>
    implements _$$GenericSmartComputerDeviceDtosImplCopyWith<$Res> {
  __$$GenericSmartComputerDeviceDtosImplCopyWithImpl(
      _$GenericSmartComputerDeviceDtosImpl _value,
      $Res Function(_$GenericSmartComputerDeviceDtosImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$GenericSmartComputerDeviceDtosImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$GenericSmartComputerDeviceDtosImpl
    extends _GenericSmartComputerDeviceDtos {
  _$GenericSmartComputerDeviceDtosImpl(
      {required this.id,
  ...
  factory _$GenericSmartComputerDeviceDtosImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$GenericSmartComputerDeviceDtosImplFromJson(json);
...
// @JsonKey(ignore: true)
  ...
  @override
  final String? smartComputerShutDownState;
  @override
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$GenericSmartComputerDeviceDtosImpl &&
            ...
            (identical(other.smartComputerShutDownState, smartComputerShutDownState) ||
                other.smartComputerShutDownState ==
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$GenericSmartComputerDeviceDtosImplCopyWith<
          _$GenericSmartComputerDeviceDtosImpl>
      get copyWith => __$$GenericSmartComputerDeviceDtosImplCopyWithImpl<
          _$GenericSmartComputerDeviceDtosImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$GenericSmartComputerDeviceDtosImplToJson(
      this,
    );
  }
}

abstract class _GenericSmartComputerDeviceDtos
    extends GenericSmartComputerDeviceDtos {
  factory _GenericSmartComputerDeviceDtos(
      ...
      final String? deviceDtoClass,
      final String? stateMassage}) = _$GenericSmartComputerDeviceDtosImpl;
  _GenericSmartComputerDeviceDtos._() : super._();

  factory _GenericSmartComputerDeviceDtos.fromJson(Map<String, dynamic> json) =
      _$GenericSmartComputerDeviceDtosImpl.fromJson;
...
// @JsonKey(ignore: true)
  ...
  @override
  String? get smartComputerShutDownState;
  @override
