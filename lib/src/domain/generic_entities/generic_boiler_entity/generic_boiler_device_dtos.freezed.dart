...
GenericBoilerDeviceDtos _$GenericBoilerDeviceDtosFromJson(
    Map<String, dynamic> json) {
  return _GenericBoilerDeviceDtos.fromJson(json);
}

/// @nodoc
mixin _$GenericBoilerDeviceDtos {
// @JsonKey(ignore: true)
  ...
  String? get boilerSwitchState => throw _privateConstructorUsedError;
  ...
  /// Serializes this GenericBoilerDeviceDtos to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of GenericBoilerDeviceDtos
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $GenericBoilerDeviceDtosCopyWith<GenericBoilerDeviceDtos> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $GenericBoilerDeviceDtosCopyWith<$Res> {
  factory $GenericBoilerDeviceDtosCopyWith(GenericBoilerDeviceDtos value,
          $Res Function(GenericBoilerDeviceDtos) then) =
      _$GenericBoilerDeviceDtosCopyWithImpl<$Res, GenericBoilerDeviceDtos>;
  @useResult
  $Res call(
      {String id,
...
/// @nodoc
class _$GenericBoilerDeviceDtosCopyWithImpl<$Res,
        $Val extends GenericBoilerDeviceDtos>
    implements $GenericBoilerDeviceDtosCopyWith<$Res> {
  _$GenericBoilerDeviceDtosCopyWithImpl(this._value, this._then);
  ...
  $Res call({
    ...
    Object? boilerSwitchState = freezed,
    ...
    return _then(_value.copyWith(
      ...
      senderId: freezed == senderId
          ...
          : senderId // ignore: cast_nullable_to_non_nullable
              as String?,
      boilerSwitchState: freezed == boilerSwitchState
          ? _value.boilerSwitchState
          : boilerSwitchState // ignore: cast_nullable_to_non_nullable
              as String?,
...
/// @nodoc
abstract class _$$GenericBoilerDeviceDtosImplCopyWith<$Res>
    implements $GenericBoilerDeviceDtosCopyWith<$Res> {
  factory _$$GenericBoilerDeviceDtosImplCopyWith(
          _$GenericBoilerDeviceDtosImpl value,
          $Res Function(_$GenericBoilerDeviceDtosImpl) then) =
      __$$GenericBoilerDeviceDtosImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String id,
...
/// @nodoc
class __$$GenericBoilerDeviceDtosImplCopyWithImpl<$Res>
    extends _$GenericBoilerDeviceDtosCopyWithImpl<$Res,
        _$GenericBoilerDeviceDtosImpl>
    implements _$$GenericBoilerDeviceDtosImplCopyWith<$Res> {
  __$$GenericBoilerDeviceDtosImplCopyWithImpl(
      _$GenericBoilerDeviceDtosImpl _value,
      $Res Function(_$GenericBoilerDeviceDtosImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$GenericBoilerDeviceDtosImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$GenericBoilerDeviceDtosImpl extends _GenericBoilerDeviceDtos {
  _$GenericBoilerDeviceDtosImpl(
      {required this.id,
  ...
  factory _$GenericBoilerDeviceDtosImpl.fromJson(Map<String, dynamic> json) =>
      _$$GenericBoilerDeviceDtosImplFromJson(json);
...
// @JsonKey(ignore: true)
  ...
  @override
  final String? boilerSwitchState;
  @override
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$GenericBoilerDeviceDtosImpl &&
            ...
            (identical(other.boilerSwitchState, boilerSwitchState) ||
                other.boilerSwitchState == boilerSwitchState) &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$GenericBoilerDeviceDtosImplCopyWith<_$GenericBoilerDeviceDtosImpl>
      get copyWith => __$$GenericBoilerDeviceDtosImplCopyWithImpl<
          _$GenericBoilerDeviceDtosImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$GenericBoilerDeviceDtosImplToJson(
      this,
    );
  }
}

abstract class _GenericBoilerDeviceDtos extends GenericBoilerDeviceDtos {
  factory _GenericBoilerDeviceDtos(
      ...
      required final String? boilerSwitchState,
      ...
      final String? deviceDtoClass,
      final String? stateMassage}) = _$GenericBoilerDeviceDtosImpl;
  _GenericBoilerDeviceDtos._() : super._();

  factory _GenericBoilerDeviceDtos.fromJson(Map<String, dynamic> json) =
      _$GenericBoilerDeviceDtosImpl.fromJson;
