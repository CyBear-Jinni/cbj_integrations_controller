...
part of 'generic_smart_type_not_supported_device_dtos.dart';
...
GenericSmartTypeNotSupportedDeviceDtos
  ...
  return _GenericSmartTypeNotSupportedDeviceDtos.fromJson(json);
}

/// @nodoc
mixin _$GenericSmartTypeNotSupportedDeviceDtos {
// @JsonKey(ignore: true)
...
/// @nodoc
abstract class $GenericSmartTypeNotSupportedDeviceDtosCopyWith<$Res> {
  factory $GenericSmartTypeNotSupportedDeviceDtosCopyWith(
          GenericSmartTypeNotSupportedDeviceDtos value,
          $Res Function(GenericSmartTypeNotSupportedDeviceDtos) then) =
      _$GenericSmartTypeNotSupportedDeviceDtosCopyWithImpl<$Res,
          GenericSmartTypeNotSupportedDeviceDtos>;
  @useResult
  $Res call(
      {String id,
...
/// @nodoc
class _$GenericSmartTypeNotSupportedDeviceDtosCopyWithImpl<$Res,
        $Val extends GenericSmartTypeNotSupportedDeviceDtos>
    implements $GenericSmartTypeNotSupportedDeviceDtosCopyWith<$Res> {
  _$GenericSmartTypeNotSupportedDeviceDtosCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$GenericSmartTypeNotSupportedDeviceDtosImplCopyWith<$Res>
    implements $GenericSmartTypeNotSupportedDeviceDtosCopyWith<$Res> {
  factory _$$GenericSmartTypeNotSupportedDeviceDtosImplCopyWith(
          _$GenericSmartTypeNotSupportedDeviceDtosImpl value,
          $Res Function(_$GenericSmartTypeNotSupportedDeviceDtosImpl) then) =
      __$$GenericSmartTypeNotSupportedDeviceDtosImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String id,
...
/// @nodoc
class __$$GenericSmartTypeNotSupportedDeviceDtosImplCopyWithImpl<$Res>
    extends _$GenericSmartTypeNotSupportedDeviceDtosCopyWithImpl<$Res,
        _$GenericSmartTypeNotSupportedDeviceDtosImpl>
    implements _$$GenericSmartTypeNotSupportedDeviceDtosImplCopyWith<$Res> {
  __$$GenericSmartTypeNotSupportedDeviceDtosImplCopyWithImpl(
      _$GenericSmartTypeNotSupportedDeviceDtosImpl _value,
  ...
  $Res call({
    ...
    return _then(_$GenericSmartTypeNotSupportedDeviceDtosImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$GenericSmartTypeNotSupportedDeviceDtosImpl
    extends _GenericSmartTypeNotSupportedDeviceDtos {
  _$GenericSmartTypeNotSupportedDeviceDtosImpl(
      {required this.id,
  ...
  factory _$GenericSmartTypeNotSupportedDeviceDtosImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$GenericSmartTypeNotSupportedDeviceDtosImplFromJson(json);
...
// @JsonKey(ignore: true)
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$GenericSmartTypeNotSupportedDeviceDtosImpl &&
  ...
  _$$GenericSmartTypeNotSupportedDeviceDtosImplCopyWith<
      ...
      get copyWith =>
          __$$GenericSmartTypeNotSupportedDeviceDtosImplCopyWithImpl<
              _$GenericSmartTypeNotSupportedDeviceDtosImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$GenericSmartTypeNotSupportedDeviceDtosImplToJson(
      this,
    );
  }
}

abstract class _GenericSmartTypeNotSupportedDeviceDtos
    extends GenericSmartTypeNotSupportedDeviceDtos {
  factory _GenericSmartTypeNotSupportedDeviceDtos(
          ...
          final String? stateMassage}) =
      _$GenericSmartTypeNotSupportedDeviceDtosImpl;
  _GenericSmartTypeNotSupportedDeviceDtos._() : super._();

  factory _GenericSmartTypeNotSupportedDeviceDtos.fromJson(
          Map<String, dynamic> json) =
