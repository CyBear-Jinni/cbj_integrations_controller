...
_$GenericSmartTypeNotSupportedDeviceDtosImpl
    _$$GenericSmartTypeNotSupportedDeviceDtosImplFromJson(
...
Map<String, dynamic> _$$GenericSmartTypeNotSupportedDeviceDtosImplToJson(
        _$GenericSmartTypeNotSupportedDeviceDtosImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
