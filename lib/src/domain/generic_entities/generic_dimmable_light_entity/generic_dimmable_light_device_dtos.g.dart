...
_$GenericDimmableLightDeviceDtosImpl
    _$$GenericDimmableLightDeviceDtosImplFromJson(Map<String, dynamic> json) =>
        _$GenericDimmableLightDeviceDtosImpl(
...
Map<String, dynamic> _$$GenericDimmableLightDeviceDtosImplToJson(
        _$GenericDimmableLightDeviceDtosImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
