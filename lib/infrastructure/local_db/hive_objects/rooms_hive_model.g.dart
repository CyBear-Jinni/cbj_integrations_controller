...
class RoomsHiveModelAdapter extends TypeAdapter<RoomsHiveModel> {
  ...
  void write(BinaryWriter writer, RoomsHiveModel obj) {
    writer
      ...
      ..writeByte(2)
      ..write(obj.roomDevicesId.toList())
      ..writeByte(3)
      ..write(obj.roomScenesId.toList())
      ..writeByte(4)
      ..write(obj.roomRoutinesId.toList())
      ..writeByte(5)
      ..write(obj.roomBindingsId.toList())
      ..writeByte(6)
      ..write(obj.roomMostUsedBy.toList())
      ..writeByte(7)
      ..write(obj.roomPermissions.toList())
      ..writeByte(8)
      ..write(obj.roomTypes.toList())
      ..writeByte(9)
