...
GenericPrinterDeviceDtos _$GenericPrinterDeviceDtosFromJson(
  ...
  return _GenericPrinterDeviceDtos.fromJson(json);
}

/// @nodoc
mixin _$GenericPrinterDeviceDtos {
// @JsonKey(ignore: true)
  ...
  String? get printerSwitchState => throw _privateConstructorUsedError;
...
/// @nodoc
abstract class $GenericPrinterDeviceDtosCopyWith<$Res> {
  factory $GenericPrinterDeviceDtosCopyWith(GenericPrinterDeviceDtos value,
          $Res Function(GenericPrinterDeviceDtos) then) =
      _$GenericPrinterDeviceDtosCopyWithImpl<$Res, GenericPrinterDeviceDtos>;
  @useResult
  $Res call(
      {String id,
...
/// @nodoc
class _$GenericPrinterDeviceDtosCopyWithImpl<$Res,
        $Val extends GenericPrinterDeviceDtos>
    implements $GenericPrinterDeviceDtosCopyWith<$Res> {
  _$GenericPrinterDeviceDtosCopyWithImpl(this._value, this._then);
  ...
  $Res call({
    ...
    Object? printerSwitchState = freezed,
    ...
    return _then(_value.copyWith(
      ...
      senderId: freezed == senderId
          ...
          : senderId // ignore: cast_nullable_to_non_nullable
              as String?,
      printerSwitchState: freezed == printerSwitchState
          ? _value.printerSwitchState
          : printerSwitchState // ignore: cast_nullable_to_non_nullable
              as String?,
...
/// @nodoc
abstract class _$$GenericPrinterDeviceDtosImplCopyWith<$Res>
    implements $GenericPrinterDeviceDtosCopyWith<$Res> {
  factory _$$GenericPrinterDeviceDtosImplCopyWith(
          _$GenericPrinterDeviceDtosImpl value,
          $Res Function(_$GenericPrinterDeviceDtosImpl) then) =
      __$$GenericPrinterDeviceDtosImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String id,
...
/// @nodoc
class __$$GenericPrinterDeviceDtosImplCopyWithImpl<$Res>
    extends _$GenericPrinterDeviceDtosCopyWithImpl<$Res,
        _$GenericPrinterDeviceDtosImpl>
    implements _$$GenericPrinterDeviceDtosImplCopyWith<$Res> {
  __$$GenericPrinterDeviceDtosImplCopyWithImpl(
      _$GenericPrinterDeviceDtosImpl _value,
  ...
  $Res call({
    ...
    return _then(_$GenericPrinterDeviceDtosImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$GenericPrinterDeviceDtosImpl extends _GenericPrinterDeviceDtos {
  _$GenericPrinterDeviceDtosImpl(
      {required this.id,
  ...
  factory _$GenericPrinterDeviceDtosImpl.fromJson(Map<String, dynamic> json) =>
      _$$GenericPrinterDeviceDtosImplFromJson(json);
...
// @JsonKey(ignore: true)
  ...
  @override
  final String? printerSwitchState;
  @override
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$GenericPrinterDeviceDtosImpl &&
            ...
            (identical(other.printerSwitchState, printerSwitchState) ||
                other.printerSwitchState == printerSwitchState) &&
  ...
  _$$GenericPrinterDeviceDtosImplCopyWith<_$GenericPrinterDeviceDtosImpl>
      get copyWith => __$$GenericPrinterDeviceDtosImplCopyWithImpl<
          _$GenericPrinterDeviceDtosImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$GenericPrinterDeviceDtosImplToJson(
      this,
    );
  }
}

abstract class _GenericPrinterDeviceDtos extends GenericPrinterDeviceDtos {
  factory _GenericPrinterDeviceDtos(
      ...
      required final String? printerSwitchState,
      required final String? lastKnownIp,
